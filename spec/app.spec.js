...
describe('/api', () => {
  ...
  it('GET 404 responds with 404 and "Page not found" error message', () => request
    .get('/ap/')
    .expect(404)
    .then((res) => {
      // console.log("ok");
  ...
  describe.only('/articles', () => {
    ...
    it('GET: status 200 and response with and array of article object with specific author', () => request
    ...
    it('GET: status 200 and response with and array of article object with specific topic', () => request
      .get('/api/articles?topic=mitch')
      .expect(200)
      .then((res) => {
        expect(res.body.articles).to.be.an('array');
        expect(res.body.articles[3].votes).to.equal(0);
      }));
    it('GET: status 200 and response with and array of custom sorted article object ', () => request
    ...
    it('GET status:200 takes sort_by query which alters the column by which data is sorted (DEFAULT order=desc)', () => request
      .get('/api/articles')
      .expect(200)
      .then((res) => {
        // console.log(res.body);
    ...
    it('GET: status 200 and response with and single article object by specific ID ', () => request
      .get('/api/articles/2')
      .expect(200)
      .then((res) => {
        // console.log(res.body.articles);
    ...
    it('GET: status 404 and response with Article not found ', () => request
    ...
    it('PATCH: status 200 if patch input data does not have body and returns unmodifed article', () => request
    ...
    it('DELETE, status:204 it  delete the given article by `article_id`', () => request
      .delete('/api/articles/1')
      .expect(204)
      .then((res) => {
        expect(res.body).to.eql({});
      }));
    it('DELETE, status:404 when the article_id does not exist', () => request
    ...
    it('POST: returns 405 if an invalid method is selected', () => request
      ...
      .expect(405)
      .then(res => expect(res.body.msg).to.equal('Method Not Allowed')));
    it('GET: status 200 and response with array of comments object for the given `article_id`', () => request
    ...
    it('GET status:200 can be sorted by author (DEFAULT order=desc)', () => request
    ...
    it('GET status:200 can be sorted by votes (DEFAULT order=desc)', () => request
    ...
    it('GET status:200 can change the sort order (DEFAULT sort_by=created_at)', () => request
    ...
    it('post: status 404 and response for non-existent article id', () => request
  ...
  describe('/comments/:comment_id', () => {
    ...
    it('DELETE, status:204 it  delete the given comment by `comment_id` with no content', () => request
    ...
    describe('/users', () => {
      ...
      it('GET, status 200 and response with a  single user object ', () => request
      ...
      it('GET, status 404 and response with user not found ', () => request
